...
unsigned int nStakeMinAge = 13 * 24 * 60 * 60; // 13 days
...
const string strMessageMagic = "SiameseCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SiameseCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "12/06/14";
        CTransaction txNew;
        txNew.nTime = 1402596025;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x4ddcdda8bef5d0249e0cf6cf9ba7a140ab1a41fb6c5ad10f42ca7640c3a21fb0"));
        block.print();
